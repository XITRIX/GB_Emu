...
private extension Square1 {
    ...
    private var nr10: UInt8 {
        get { mmu.read(0xFF10) }
        set { mmu.write(newValue, to: 0xFF10) }
    }

    private var nr11: UInt8 {
        get { mmu.read(0xFF11) }
        set { mmu.write(newValue, to: 0xFF11) }
    }

    private var nr12: UInt8 {
        get { mmu.read(0xFF12) }
        set { mmu.write(newValue, to: 0xFF12) }
    }

    private var nr13: UInt8 {
        get { mmu.read(0xFF13) }
        set { mmu.write(newValue, to: 0xFF13) }
    }

    private var nr14: UInt8 {
        get { mmu.read(0xFF14) }
        set {
            mmu.write(newValue, to: 0xFF14)
            // length enable bit
